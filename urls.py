...
urlpatterns = patterns('',
    ...
    url(r'^gear_equip_test', views.GearEquipTestView, name='gear_equip'),
    url(r'^gear2_equip_test', views.GearEquipTestView2, name='gear_equip2'),
    url(r'^gear_table', views.GearTableView, name='gear_table'),
